...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package lsp-julia
    :config (setq lsp-julia-default-environment "~/.julia/environments/v1.11") ;; change
    )
  ...
  (use-package julia-mode
    ...
    :hook ((julia-mode . outline-minor-mode)
  	 ...
  	 (julia-mode . (lambda () (setq company-minimum-prefix-length 0) (corfu-mode nil)))
  ...
  (use-package julia-snail
    ...
    (defun my/julia-sendsubtree (&optional p0 p1)
      ...
      (let* ((p0 (or p0 (outline-previous-heading) (point-min)))
        ...
        (julia-snail--send-to-repl (buffer-substring p0 p1))
        (julia-snail--flash-region p0 p1)
        )
      )
