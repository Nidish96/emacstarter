...
#+begin_src emacs-lisp :tangle yes
  (use-package vertico
    :ensure t
    :hook (rfn-eshadow-update-overlay . (lambda () (interactive) (vertico-directory-tidy)))
    :custom
    (vertico-cycle t)
...
(use-package consult
  :ensure t
  :bind (("C-c h f" . consult-recent-file)
         ("C-c h b" . consult-buffer)      ; like helm-mini
         ("C-c h r" . consult-ripgrep)     ; like helm-rg
         ("C-c h l" . consult-line)        ; like helm-occur
...
#+begin_src emacs-lisp :tangle yes
  (use-package typst-ts-mode
    ...
    ;; (setq typst-ts-compile-options "--font-path ~/.local/share/fonts/")
