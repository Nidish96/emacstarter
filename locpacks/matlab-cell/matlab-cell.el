...
;; Maintainer: Nidish Narayanaa Balaji <nidbid@gmail.com>
;; URL: 
;; Version: 1.0
;; Package-Requires: ((emacs "25.1"))
;; Created: 2024-05-14
;; Keywords: extensions, matlab, Matlab, cell
...
;; Major parts of the code were taken from python-cell.el by Thomas Hisch (https://github.com/thisch/matlab-cell.el)
...
(defun matlab-cell-beginning-of-cell (&optional arg)
  (interactive "p")
...
(defun matlab-cell-end-of-cell (&optional arg)
  (interactive "p")
...
(defun matlab-cell-highlight ()
  ...
  (if matlab-cell-mode  ; Might be changed outside the mode function.
      (progn
        ...
        (matlab-cell-move matlab-cell-overlay))
...
(defun matlab-cell-move (overlay)
